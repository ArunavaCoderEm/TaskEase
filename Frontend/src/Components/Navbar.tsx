    ...
    <>
      <nav className="bg-gradient-to-b from-violet-500 to-violet-800">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <Link to='/signup' className='p-2 bg-gradient-to-b from-violet-400 px-2 shab to-violet-600 block right-0 mx-10 rounded-md text-center font-thin text-white' onClick={() => {setMenu('none')}}>
            sign in
          </Link>
          <Link to='/login' className='p-2 bg-gradient-to-b from-violet-400 px-2 sm:mx-10 lg:mx-0 shab to-violet-600 block right-0 rounded-md text-center font-thin text-white' onClick={() => {setMenu('none')}}>
            log in
          </Link>
          </div>
        </div>
